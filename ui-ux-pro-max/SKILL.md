...
| Source | Use |
|--------|-----|
| **[21st.dev](https://21st.dev)** — Community registry of 10,000+ hand-crafted React/Tailwind CSS components and templates. | Reference for sourcing production-ready UI components when building with React + Tailwind. Components ship as AI-ready prompts or via shadcn CLI. Free tier: 2 copies/day. Integrates with Cursor, Claude Code, v0, Lovable.
| **[shadcn/ui](https://ui.shadcn.com)** | Official shadcn/ui docs for accessible Radix-based components.
| **[Tailwind UI](https://tailwindui.com)** | Official Tailwind component templates.
