...
| Skill | Description | Source |
|-------|-------------|--------|
| **[configure-9router](configure-9router/)** | 9router model combo management via SQLite — register/whitelist models, manage routing combos, blacklist models, audit usage. Backup automation, pre-edit hooks, inventory tracking. | **[9router](https://github.com/decolua/9router)** — [decolua](https://github.com/decolua) | MIT |
